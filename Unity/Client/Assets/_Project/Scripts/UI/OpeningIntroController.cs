...
namespace ProjectLimitless.UI
{
    ...
    public sealed class OpeningIntroController : MonoBehaviour
    {
        ...
        private void ApplySlide(OpeningIntroSlide slide)
        {
            ...
            glow.gameObject.SetActive(slide.Visual == OpeningIntroVisual.Light || slide.Visual == OpeningIntroVisual.Gift || slide.Visual == OpeningIntroVisual.Limit);
        ...
        private void AnimateVisual(OpeningIntroVisual visual, float progress)
        {
            ...
            {
                glow.rectTransform.localScale = Vector3.one * Mathf.Lerp(.25f, 1.4f, progress);
                glow.color = new Color(1f, .82f, .38f, Mathf.Lerp(.08f, .28f, progress));
            }
        ...
        private void CreateInterface()
        {
            ...
            glow = MakeImage(canvasObject.transform, "AbstractLight", new Color(1f, .82f, .38f, .15f)); SetRect(glow.rectTransform, new Vector2(.5f, .56f), new Vector2(260, 260));
