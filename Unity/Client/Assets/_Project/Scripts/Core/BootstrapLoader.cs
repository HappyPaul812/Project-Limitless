...
namespace ProjectLimitless.Core
{
    ...
    public sealed class BootstrapLoader : MonoBehaviour
    {
        ...
        private static string GetSceneName(string id) { if (id == "World_StarterVillage") return "시작 마을"; if (id == "Field_01") return "초원"; if (id == "Field_02") return "그늘진 숲길"; if (id == "Field_03") return "침묵의 숲길"; return id; }
