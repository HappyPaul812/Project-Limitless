...
- 갱신일: 2026-08-26
- 기준 브랜치: `main`
- 마지막 기능 관련 commit: `cd8119f` (`Feature: 투사 회오리 베기 구현`)
...
- 투사 `회오리 베기`: 전열·후열의 살아 있는 적 전체에 일반 공격 80% 피해, 실제 적중 1명당 기세 +1(최대 3), 자체 쿨타임 없음
...
84. 투사 스킬 메뉴에 spinner 아이콘+회오리 베기가 표시되고 Hover·키보드 포커스 설명에 적 전체·80%·적중당 기세 +1·최대 3·재사용 없음이 보이는지 확인한다.
85. 살아 있는 적이 1/2/3명일 때 회오리 베기가 전열·후열 모두에 각각 80% 정수 올림 피해를 동시에 적용하고 기세가 각각 +1/+2/+3 되는지 확인한다.
...
Unity 16:9 Play Mode에서 회오리 베기의 적 1~3명 80% 동시 피해·적중당 기세 획득·최대 3·난도 쿨타임 비발생과 spinner/회전 참격 연출을 우선 확인한다. 이어 회심의 일격 190% 소비 연계와 기존 난도·도발·치유의 빛·정조준·취소 흐름 회귀를 확인한다.
