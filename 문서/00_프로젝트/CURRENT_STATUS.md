...
- 갱신일: 2026-08-31
- 기준 브랜치: `main`
- 마지막 기능 관련 commit: `900e9f8` (`Feature: 독침벌 독 부여 대기시간 적용`)
...
다음 권장 작업은 Battle Play Mode에서 독침벌 4행동의 `독 부여→대기 2→1→0→재부여`, 정화 직후 재독 방지와 복수 독침벌의 독립 대기시간을 검증하는 것이다. 정화의 복합 상태 제거와 독·화상 동시 틱 회귀도 함께 확인한다.
