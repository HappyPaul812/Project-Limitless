...
- 갱신일: 2026-08-25
- 기준 브랜치: `main`
- 마지막 기능 관련 commit: `7de1918` (`Refactor: 전투 스킬 설명 UI 정리`)
...
Unity 16:9 Play Mode에서 스킬 버튼 Hover·키보드 포커스 팝업, 단순화된 이름 배치와 arrowLeft 취소 아이콘을 우선 확인한다. 이어 도발·치유의 빛·정조준의 피해·회복·쿨타임·대상 판정 회귀를 확인하고 다음 직업 스킬을 선정한다.
