...
- 갱신일: 2026-08-31
- 기준 브랜치: `main`
- 마지막 기능 관련 commit: `9bfac43` (`Feature: 수호자 철벽 스킬 구현`)
...
다음 권장 작업은 Battle Play Mode에서 수호자 철벽의 Earth Rupture 크기·피해 10→3·`철벽 2→1→제거`·공용 방어 차단·도발 병존·4턴 쿨타임을 우선 검증하는 것이다. 독침벌 4행동과 정화 복합 상태 제거 회귀도 함께 확인한다.
