...
Unity Play Mode에서 Field_02 거미 조우가 독침벌 A/B·숲거미 1인지, 기본 공격 데이터가 벌 12·거미 14인지 확인한다. 이어 독액 분사 20이 대신 막기 사용 전 각 아군 20, 사용 후 아군 최대 10과 수호자 이전 예정 5로 처리되고 철벽은 실제 이전 피해만 70% 줄이는지 확인한다. Field 왕복·안전지대·거미 필드 배치 회귀와 실제 Play Mode 확인은 남아 있다.
