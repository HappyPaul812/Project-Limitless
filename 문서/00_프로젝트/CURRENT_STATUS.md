...
- 갱신일: 2026-08-26
- 기준 브랜치: `main`
- 마지막 기능 관련 commit: `eb39cfe` (`Feature: 사수 화살비 구현`)
...
Unity 16:9 Play Mode에서 화살비의 후열 1~3명 120% 단일 피해·전열 완전 제외·후열 0명 행동 미소비와 bow/golden_arrow 상승·낙하 연출을 우선 확인한다. 이어 도발 무시, 방어 50%, 기존 정조준·회오리 베기·난도·회심의 일격·치유의 빛·취소 흐름 회귀를 확인한다.
