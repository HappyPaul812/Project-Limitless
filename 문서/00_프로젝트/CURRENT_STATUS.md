...
- 갱신일: 2026-08-26
- 기준 브랜치: `main`
- 마지막 기능 관련 commit: `84c8cae` (`Feature: 투사 기세와 회심의 일격 구현`)
...
- 투사 난도·회심의 일격을 제외한 회오리 베기 등 나머지 직업별 스킬 효과와 길 패시브
...
Unity 16:9 Play Mode에서 기세별 회심의 일격 100/130/160/190%·적중 후 소비, 난도 쿨타임 유지, skull HUD·설명 팝업과 Esc 복귀를 우선 확인한다. 이어 기존 난도·도발·치유의 빛·정조준 회귀를 확인하고 회오리 베기 실제 구현을 검토한다.
